...
<section class="library-page">
  <div class="page-tools"><span class="page-eyebrow">{library.length} saved {library.length === 1 ? 'title' : 'titles'}</span><a class="btn btn-sm btn-ghost" href="/downloads">Manage downloads</a></div>
